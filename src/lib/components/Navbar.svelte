    ...
    <div class="flex justify-between items-center py-4">
      ...
      <div class="hidden md:flex items-center gap-6">
        ...
        <div class="relative" bind:this={langMenuRef}>
          <button on:click={toggleLangMenu} class="flex items-center gap-1 text-sm text-foreground hover:opacity-80 cursor-pointer">
            {currentLanguageName}
        ...
        <a
          href="/{lang}/guide"
          class="px-4 py-2 bg-primary text-primary-foreground rounded-xl hover:opacity-80 font-bold cursor-pointer transition-colors"
        >
  ...
  {#if mobileMenuOpen}
    <div bind:this={mobileMenuRef} class="md:hidden absolute top-full left-0 right-0 bg-card border-b border-border shadow-sm z-[9999]">
      <div class="max-w-5xl mx-auto px-4 py-4 space-y-4">
        ...
        <!-- Theme Toggle (Mobile) -->
        <button on:click={toggleTheme} class="flex items-center gap-2 px-2 py-1 text-foreground hover:opacity-80 cursor-pointer">
          {#if isDark}
            <Sun class="w-5 h-5" />
        ...
        <a
            ...
            class="block px-4 py-2 bg-primary text-primary-foreground rounded-xl hover:opacity-80 font-bold text-center transition-colors"
          >
            {t.guide.startReading}
          </a>
